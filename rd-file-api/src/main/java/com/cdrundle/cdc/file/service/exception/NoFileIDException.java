 ...
 */
public class NoFileIDException extends BaseException {
	...
	public NoFileIDException() {
		super(FileMessageRepository.getInstance().getCode(FileMessageRepository.NO_FILE_ID),
				FileMessageRepository.getInstance().getMessage(FileMessageRepository.NO_FILE_ID));
	}
