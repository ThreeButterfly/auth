 ...
 */
public class FileGetFailException extends BaseException {
	...
	public FileGetFailException() {
		super(FileMessageRepository.getInstance().getCode(FileMessageRepository.FILE_GET_FAIL),
				FileMessageRepository.getInstance().getMessage(FileMessageRepository.FILE_GET_FAIL));
	}
