...
public class FileUploadFailException extends BaseException {
	...
	public FileUploadFailException() {
		super(FileMessageRepository.getInstance().getCode(FileMessageRepository.FILE_UPLOAD_FAIL),
				FileMessageRepository.getInstance().getMessage(FileMessageRepository.FILE_UPLOAD_FAIL));
	}
