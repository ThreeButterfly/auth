...
public class DeleteFileException extends BaseException {
	...
	public DeleteFileException() {
		super(FileMessageRepository.getInstance().getCode(FileMessageRepository.DELETE_FILE_FAIL),
				FileMessageRepository.getInstance().getMessage(FileMessageRepository.DELETE_FILE_FAIL));
	}
