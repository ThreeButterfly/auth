 ...
 */
public class FileParmFailException extends BaseException {
	...
	public FileParmFailException() {
		super(FileMessageRepository.getInstance().getCode(FileMessageRepository.FILE_PARM_FAIL),
				FileMessageRepository.getInstance().getMessage(FileMessageRepository.FILE_PARM_FAIL));
	}
